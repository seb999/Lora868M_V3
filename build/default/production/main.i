...
_Bool isGpsAccess = 0;
_Bool isLoraAccess = 0;
_Bool isMotionStopped = 0;
...
_Bool ReadGPS()
{
    ...
    latitude = strtok (((void*)0),".");
    latitudeDec = strtok (((void*)0),",");
    ...
    longitude = strtok (((void*)0),".");
    longitudeDec = strtok (((void*)0),",");
