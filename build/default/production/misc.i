...
void __delay_sec(int n){
    while(n--) _delay((unsigned long)((1000)*(32000000/4000.0)));
}

void blinkRed(int n){
    while(n--){
        do { LATCbits.LATC6 = 1; } while(0);
        _delay((unsigned long)((75)*(32000000/4000.0)));
...
void EUART_GPS(void)
{
    ...
    RC4PPSbits.RC4PPS = 0x14;
    RXPPSbits.RXPPS = 0x15;
    RA4PPSbits.RA4PPS = 0x0;
...
void EUART_LORA(void)
{
    ...
    RA4PPSbits.RA4PPS = 0x14;
    RXPPSbits.RXPPS = 0x05;
    RC4PPSbits.RC4PPS = 0x0;
    PORTCbits.RC4 = 1;
